 ...
 * Stub hash: 68ac4d2598b9f0c1ed220d68aa223ef1f66df9a2 */
...
#if defined(LIBXML_XPATH_ENABLED)
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_DOM_XPath_evaluate, 0, 1, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, expression, IS_STRING, 0)
...
static const zend_function_entry class_DOMDocument_methods[] = {
	...
	ZEND_MALIAS(DOMElement, getElementsByTagName, getElementsByTagName, arginfo_class_DOMDocument_getElementsByTagName, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, getElementsByTagNameNS, getElementsByTagNameNS, arginfo_class_DOMDocument_getElementsByTagNameNS, ZEND_ACC_PUBLIC)
...
static const zend_function_entry class_DOM_ParentNode_methods[] = {
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ParentNode, append, arginfo_class_DOM_ParentNode_append, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ParentNode, prepend, arginfo_class_DOM_ParentNode_prepend, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ParentNode, replaceChildren, arginfo_class_DOM_ParentNode_replaceChildren, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_ChildNode_methods[] = {
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ChildNode, remove, arginfo_class_DOM_ChildNode_remove, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ChildNode, before, arginfo_class_DOM_ChildNode_before, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ChildNode, after, arginfo_class_DOM_ChildNode_after, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_ABSTRACT_ME_WITH_FLAGS(DOM_ChildNode, replaceWith, arginfo_class_DOM_ChildNode_replaceWith, ZEND_ACC_PUBLIC|ZEND_ACC_ABSTRACT)
	ZEND_FE_END
};
...
static const zend_function_entry class_DOM_Node_methods[] = {
	...
	ZEND_MALIAS(DOMNode, getRootNode, getRootNode, arginfo_class_DOM_Node_getRootNode, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, hasChildNodes, hasChildNodes, arginfo_class_DOM_Node_hasChildNodes, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, normalize, normalize, arginfo_class_DOM_Node_normalize, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, cloneNode, cloneNode, arginfo_class_DOM_Node_cloneNode, ZEND_ACC_PUBLIC)
	...
	ZEND_MALIAS(DOMNode, lookupNamespaceURI, lookupNamespaceURI, arginfo_class_DOM_Node_lookupNamespaceURI, ZEND_ACC_PUBLIC)
	...
	ZEND_MALIAS(DOMNode, getLineNo, getLineNo, arginfo_class_DOM_Node_getLineNo, ZEND_ACC_PUBLIC)
	ZEND_ME(DOM_Node, getNodePath, arginfo_class_DOM_Node_getNodePath, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, C14N, C14N, arginfo_class_DOM_Node_C14N, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, C14NFile, C14NFile, arginfo_class_DOM_Node_C14NFile, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, __sleep, __sleep, arginfo_class_DOM_Node___sleep, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNode, __wakeup, __wakeup, arginfo_class_DOM_Node___wakeup, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_NodeList_methods[] = {
	ZEND_MALIAS(DOMNodeList, count, count, arginfo_class_DOM_NodeList_count, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNodeList, getIterator, getIterator, arginfo_class_DOM_NodeList_getIterator, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNodeList, item, item, arginfo_class_DOM_NodeList_item, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_NamedNodeMap_methods[] = {
	ZEND_MALIAS(DOMNamedNodeMap, item, item, arginfo_class_DOM_NamedNodeMap_item, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNamedNodeMap, getNamedItem, getNamedItem, arginfo_class_DOM_NamedNodeMap_getNamedItem, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNamedNodeMap, getNamedItemNS, getNamedItemNS, arginfo_class_DOM_NamedNodeMap_getNamedItemNS, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNamedNodeMap, count, count, arginfo_class_DOM_NamedNodeMap_count, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNamedNodeMap, getIterator, getIterator, arginfo_class_DOM_NamedNodeMap_getIterator, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_HTMLCollection_methods[] = {
	ZEND_MALIAS(DOMNodeList, item, item, arginfo_class_DOM_HTMLCollection_item, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNodeList, count, count, arginfo_class_DOM_HTMLCollection_count, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMNodeList, getIterator, getIterator, arginfo_class_DOM_HTMLCollection_getIterator, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_Element_methods[] = {
	ZEND_MALIAS(DOMNode, hasAttributes, hasAttributes, arginfo_class_DOM_Element_hasAttributes, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, getAttributeNames, getAttributeNames, arginfo_class_DOM_Element_getAttributeNames, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, getAttribute, getAttribute, arginfo_class_DOM_Element_getAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, getAttributeNS, getAttributeNS, arginfo_class_DOM_Element_getAttributeNS, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, setAttribute, setAttribute, arginfo_class_DOM_Element_setAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, setAttributeNS, setAttributeNS, arginfo_class_DOM_Element_setAttributeNS, ZEND_ACC_PUBLIC)
	ZEND_ME(DOM_Element, removeAttribute, arginfo_class_DOM_Element_removeAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, removeAttributeNS, removeAttributeNS, arginfo_class_DOM_Element_removeAttributeNS, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, toggleAttribute, toggleAttribute, arginfo_class_DOM_Element_toggleAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, hasAttribute, hasAttribute, arginfo_class_DOM_Element_hasAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, hasAttributeNS, hasAttributeNS, arginfo_class_DOM_Element_hasAttributeNS, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, getAttributeNode, getAttributeNode, arginfo_class_DOM_Element_getAttributeNode, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, getAttributeNodeNS, getAttributeNodeNS, arginfo_class_DOM_Element_getAttributeNodeNS, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOM_Element, setAttributeNode, setAttributeNodeNS, arginfo_class_DOM_Element_setAttributeNode, ZEND_ACC_PUBLIC)
	...
	ZEND_MALIAS(DOMElement, insertAdjacentText, insertAdjacentText, arginfo_class_DOM_Element_insertAdjacentText, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, setIdAttribute, setIdAttribute, arginfo_class_DOM_Element_setIdAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, setIdAttributeNS, setIdAttributeNS, arginfo_class_DOM_Element_setIdAttributeNS, ZEND_ACC_PUBLIC)
	ZEND_ME(DOM_Element, setIdAttributeNode, arginfo_class_DOM_Element_setIdAttributeNode, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, remove, remove, arginfo_class_DOM_Element_remove, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, before, before, arginfo_class_DOM_Element_before, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, after, after, arginfo_class_DOM_Element_after, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, replaceWith, replaceWith, arginfo_class_DOM_Element_replaceWith, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, append, append, arginfo_class_DOM_Element_append, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, prepend, prepend, arginfo_class_DOM_Element_prepend, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, replaceChildren, replaceChildren, arginfo_class_DOM_Element_replaceChildren, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_Attr_methods[] = {
	ZEND_MALIAS(DOMAttr, isId, isId, arginfo_class_DOM_Attr_isId, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_CharacterData_methods[] = {
	ZEND_MALIAS(DOMCharacterData, substringData, substringData, arginfo_class_DOM_CharacterData_substringData, ZEND_ACC_PUBLIC)
	...
	ZEND_MALIAS(DOMElement, remove, remove, arginfo_class_DOM_CharacterData_remove, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, before, before, arginfo_class_DOM_CharacterData_before, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, after, after, arginfo_class_DOM_CharacterData_after, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, replaceWith, replaceWith, arginfo_class_DOM_CharacterData_replaceWith, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_Text_methods[] = {
	ZEND_MALIAS(DOMText, splitText, splitText, arginfo_class_DOM_Text_splitText, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
...
static const zend_function_entry class_DOM_DocumentType_methods[] = {
	ZEND_MALIAS(DOMElement, remove, remove, arginfo_class_DOM_DocumentType_remove, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, before, before, arginfo_class_DOM_DocumentType_before, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, after, after, arginfo_class_DOM_DocumentType_after, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, replaceWith, replaceWith, arginfo_class_DOM_DocumentType_replaceWith, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};


static const zend_function_entry class_DOM_DocumentFragment_methods[] = {
	ZEND_MALIAS(DOMDocumentFragment, appendXML, appendXML, arginfo_class_DOM_DocumentFragment_appendXML, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, append, append, arginfo_class_DOM_DocumentFragment_append, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, prepend, prepend, arginfo_class_DOM_DocumentFragment_prepend, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMElement, replaceChildren, replaceChildren, arginfo_class_DOM_DocumentFragment_replaceChildren, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
...
static const zend_function_entry class_DOM_Document_methods[] = {
	ZEND_MALIAS(DOM_Element, getElementsByTagName, getElementsByTagName, arginfo_class_DOM_Document_getElementsByTagName, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOM_Element, getElementsByTagNameNS, getElementsByTagNameNS, arginfo_class_DOM_Document_getElementsByTagNameNS, ZEND_ACC_PUBLIC)
	...
	ZEND_MALIAS(DOMDocument, createDocumentFragment, createDocumentFragment, arginfo_class_DOM_Document_createDocumentFragment, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMDocument, createTextNode, createTextNode, arginfo_class_DOM_Document_createTextNode, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMDocument, createCDATASection, createCDATASection, arginfo_class_DOM_Document_createCDATASection, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMDocument, createComment, createComment, arginfo_class_DOM_Document_createComment, ZEND_ACC_PUBLIC)
	...
	ZEND_MALIAS(DOMDocument, createAttribute, createAttribute, arginfo_class_DOM_Document_createAttribute, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMDocument, createAttributeNS, createAttributeNS, arginfo_class_DOM_Document_createAttributeNS, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMDocument, getElementById, getElementById, arginfo_class_DOM_Document_getElementById, ZEND_ACC_PUBLIC)
	ZEND_ME(DOM_Document, registerNodeClass, arginfo_class_DOM_Document_registerNodeClass, ZEND_ACC_PUBLIC)
#if defined(LIBXML_SCHEMAS_ENABLED)
	ZEND_MALIAS(DOMDocument, schemaValidate, schemaValidate, arginfo_class_DOM_Document_schemaValidate, ZEND_ACC_PUBLIC)
#endif
#if defined(LIBXML_SCHEMAS_ENABLED)
	ZEND_MALIAS(DOMDocument, schemaValidateSource, schemaValidateSource, arginfo_class_DOM_Document_schemaValidateSource, ZEND_ACC_PUBLIC)
#endif
#if defined(LIBXML_SCHEMAS_ENABLED)
	ZEND_MALIAS(DOMDocument, relaxNGValidate, relaxNGValidate, arginfo_class_DOM_Document_relaxNGValidate, ZEND_ACC_PUBLIC)
#endif
#if defined(LIBXML_SCHEMAS_ENABLED)
	ZEND_MALIAS(DOMDocument, relaxNGValidateSource, relaxNGValidateSource, arginfo_class_DOM_Document_relaxNGValidateSource, ZEND_ACC_PUBLIC)
#endif
...
static const zend_function_entry class_DOM_HTMLDocument_methods[] = {
	...
	ZEND_MALIAS(DOM_XMLDocument, saveXML, saveXML, arginfo_class_DOM_HTMLDocument_saveXML, ZEND_ACC_PUBLIC)
...
static const zend_function_entry class_DOM_XPath_methods[] = {
	...
	ZEND_MALIAS(DOMXPath, registerNamespace, registerNamespace, arginfo_class_DOM_XPath_registerNamespace, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMXPath, registerPhpFunctions, registerPhpFunctions, arginfo_class_DOM_XPath_registerPhpFunctions, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(DOMXPath, registerPhpFunctionNS, registerPhpFunctionNS, arginfo_class_DOM_XPath_registerPhpFunctionNS, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
#endif
